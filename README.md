...
public class NumberToCN{
     ...
     * 汉语中数字大写
     */
    private final String[] CN_UPPER_NUMBER = { "零", "壹", "贰", "叁", "肆",
            "伍", "陆", "柒", "捌", "玖" };
    /**
    ...
    public static void main(String[] args) {
    	Double ss=new Double(99);
		System.out.println(new NumberToCN().number2CNMontrayUnit(new BigDecimal(Double.toString(1002540.5))));
	}
}
